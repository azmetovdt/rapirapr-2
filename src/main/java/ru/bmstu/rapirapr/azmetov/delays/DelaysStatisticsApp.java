...
public class DelaysStatisticsApp {
    public static void main(String[] args) throws Exception {
        ...
        MultipleInputs.addInputPath(job, new Path(args[0]), FileInputFormat.class, AirportsJoinMapper.class);
        MultipleInputs.addInputPath(job, new Path(args[1]), FileInputFormat.class, FlightsJoinMapper.class);
